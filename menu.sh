...
display_menu() {
    ...
    echo -e "\e[32m─────────────────────────────────────────────────────────────────────\e[0m"
    echo -e "\e[32m1.  Set Static IP Address             14. Show Installed Tools Status\e[0m"
    echo -e "\e[91m2.  UFW Firewall Management\e[32m            15. Setup Nginx Configuration\e[0m"
    echo -e "\e[32m3.  Install SSH Server                 16. Install Composer\e[0m"
    echo -e "\e[32m4.  Install Apache Web Server          17. Setup Project Folder (Nginx)\e[0m"
